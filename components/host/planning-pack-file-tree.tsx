...
export type PlanningPackFileTreeProps = PlanningPackGalleryProps;
...
export function PlanningPackFileTree({
  tabs,
  manifest,
  loading = false,
  loadError,
...
export const PlanningPackGallery = PlanningPackFileTree;
